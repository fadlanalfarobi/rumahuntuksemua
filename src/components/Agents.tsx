...
const Agents = () => {
  const agents = [
    ...
    },
    {
      ...
      title: "Ahli Penjual Pertama Kali",
    ...
    <div className="py-16 bg-muted">
      <div className="container-custom">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Temui Agen Ahli Kami</h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Tim profesional berpengalaman kami siap membimbing Anda melalui proses penjualan
          </p>
        </div>
          ...
          {agents.map((agent) => (
            <Card key={agent.id} className="overflow-hidden hover-lift shadow-custom">
              ...
              <CardContent className="text-center py-6">
                ...
                <p className="text-muted-foreground mb-4">{agent.experience} pengalaman</p>
                ...
                <Button variant="outline" className="w-full">Hubungi Agen</Button>
              </CardContent>
            </Card>
          ))}
        </div>
